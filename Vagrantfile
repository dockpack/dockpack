...
Vagrant.configure(2) do |config|
  ...
  config.vm.define :windows, autostart: true do |windows_config|
    ...
    windows_config.vm.network :forwarded_port, guest: 3389, host: 3389, id: "rdp", auto_correct: false
  ...
  config.vm.define :ubuntu14, autostart: true do |ubuntu14_config|
    ...
    ubuntu14_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2202, auto_correct: false
  ...
  config.vm.define :fedora, autostart: true do |fedora_config|
    ...
    fedora_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2203, auto_correct: false
  ...
  config.vm.define :coreos, autostart: true do |coreos_config|
    ...
    coreos_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2204, auto_correct: false
  ...
  config.vm.define "kali", autostart: false do |kali_config|
    ...
    kali_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2205, auto_correct: false
  ...
  config.vm.define :centos6, autostart: true do |centos6_config|
    ...
    centos6_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2206, auto_correct: false
  ...
  config.vm.define :centos7, primary: true, autostart: true do |centos7_config|
    ...
    centos7_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2207, auto_correct: false
  ...
  config.vm.define :atomic, primary: true, autostart: true do |atomic_config|
    atomic_config.vm.box = "centos/atomic-host"
    atomic_config.vm.network "forwarded_port", id: 'ssh', guest: 22, host: 2208, auto_correct: false

    atomic_config.vm.provider "vmware_fusion" do |vmware|
      vmware.vmx["memsize"] = "2048"
      vmware.vmx["numvcpus"] = "2"
    end
    atomic_config.vm.provider "virtualbox" do |vb|
      vb.name = "centos7"
    end
